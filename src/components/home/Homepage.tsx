  ...
  <>
    ...
    <motion.div variants={fadeInUp}>
      <Paragraph>
        ...
        <strong>Remix.run</strong> are my go-to weapons, but sometimes, I
        dive into the world of NFT smart contracts with{" "}
        <strong>Scilla</strong> on <strong>Zilliqa</strong>. You could say
